...
After mapping, send the JSON + a description of the manual process to Claude (or any AI assistant):
...
> **Tip:** Use the **⧉ Copy JSON** button to copy directly to clipboard without downloading a file.
